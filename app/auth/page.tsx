...
export default function AuthPage() {
  ...
  const handleCredentialSignIn = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const email = form.credential.value
  ...
  const handleGitHubAuth = () => {
    ...
    // TODO: Implement GitHub OAuth register logic
  };

  const handleGoogleAuth = () => {
    console.log("Google sign in triggered!");
    // TODO: Implement Google OAuth register logic
  };
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6">
      ...
      >
        <div className="mb-4">
          <label htmlFor="credential" className="block mb-2 text-sm font-medium">
            Email or Username
          </label>
          <input
            type="text"
